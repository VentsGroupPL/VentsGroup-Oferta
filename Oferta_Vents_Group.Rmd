...
<!-- DODANE: Responsywność tabel na mobile (bez zmiany treści) -->
<style>
/* lepsze przewijanie dotykowe (nie zmienia oryginalnego scroll_css) */
.table-wrap, .table-responsive { overflow-x:auto; -webkit-overflow-scrolling: touch; }

/* MOBILE: układ kartowy dla kableExtra */
@media (max-width: 768px) {
  ...
  table.kable td {
    ...
    white-space: normal !important;    /* nadpisuje nowrap z column_spec wyłącznie na mobile */
    vertical-align: top;
...
<!-- DODANE: Skrypt etykiet data-label dla komórek (pobiera nagłówki thead) -->
<script>
...
<div class="lang-switch">
  <a href="https://ventsgrouppl.github.io/VentsGroup-Offer/" class="lang-btn" target="_self">       
  <img src="images/EN.jpg" alt="English" style="height:20px; vertical-align:middle;">
  </a>
</div>
```
![](images/VG.jpg)
...
# Jesteśmy w grupie Blauberg


Przedstawicielstwa i oddziały partnerskie Blauberg Group znajdują się w wielu krajach, na różnych kontynentach, aby zapewnić terminowość dostaw produktów i usług do wszystkich klientów. 

W zakładach produkcyjnych o powierzchni ponad 210 000 m², zatrudniamy przeszło 3 500 wysoko wykwalifikowanych specjalistów, którzy wytwarzają produkty najwyższej jakości, oferowane w ponad 120 krajach na całym świecie.


![](images/mapka.jpg)

Dowiedz się więcej na [stronie Vents Group](https://vents-group.pl/) lub [blauberg.pl](https://www.blauberg.pl/).
